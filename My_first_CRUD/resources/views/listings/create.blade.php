      ...
      <form method="POST" action="/listings" enctype="multipart/form-data">
        ...
        <div class="mb-6">
          ...
          <input type="text" class="border border-gray-200 rounded p-2 w-full" name="location"
            placeholder="Example: Malaysia, USA..." value="{{old('location')}}" />
        ...
        <div class="mb-6">
          <label for="tags" class="inline-block text-lg mb-2">
            Tags - Add Interesting tags for your image! (Comma seperated)
          </label>
          <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags"
            placeholder="Example: Aesthetic, Food, Figurines..." value="{{old('tags')}}" />
        ...
        <div class="mb-6">
          ...
          <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10"
            placeholder="What is this picture about...?">{{old('description')}}</textarea>
